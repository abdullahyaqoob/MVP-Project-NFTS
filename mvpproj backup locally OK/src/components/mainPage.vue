  ...
  <div>
    <div class="wrapper">
      <div>
        ...
        <div class="navBtns">
          <router-link to="nft"><button class="navBtn" id="selected">NFT</button></router-link>
          <!-- <a href="nft"><button class="navBtn" id="selected">NFT</button></a> -->
          <router-link to="/"><button class="navBtn">Home Page</button></router-link>
        </div>
      </div>
    </div>
    <div class="secondDiv">
        ...
        this.$http
          ...
          .then(function (data) {
            ...
            if (this.contractAddress.length !== 42) {
              ...
              console.log("here");
              this.$http
                .get("http://34.197.13.155/one/token/" + this.contractAddress)
